...
基于 `electronuserland/builder` 镜像，安装指定完整版本的 Node.js 和 pnpm。

tag 格式：`electronuserland_builder@<builder版本>_<node完整版本>`

- 第 1 段（`@` 后）：builder 基础镜像版本
- 第 2 段（`_` 后）：Node.js 完整版本号

例如：`electronuserland_builder@20-wine-03.25_22.22.2`
- builder 版本：`20-wine-03.25`
- Node.js 版本：`22.22.2`
- 最终推送的镜像为：`electronuserland-builder:20-wine-03.25-node22.22.2`
